...
bool deserialize_sequence_byte_1(MicroBuffer* buffer, Endianness endianness, uint8_t* array, uint32_t* size, const uint32_t max_size);
bool deserialize_sequence_byte_2(MicroBuffer* buffer, Endianness endianness, uint16_t* array, uint32_t* size, const uint32_t max_size);
bool deserialize_sequence_byte_4(MicroBuffer* buffer, Endianness endianness, uint32_t* array, uint32_t* size, const uint32_t max_size);
bool deserialize_sequence_byte_8(MicroBuffer* buffer, Endianness endianness, uint64_t* array, uint32_t* size, const uint32_t max_size);
