...
* @return 0 is returned when the deserialized works successfully. Otherwise, -1 is returned.
*/
microcdr_DllAPI int8_t deserializeUnsignedLongLongEndianness(unsigned long long int *ulonglong_t, Endianness endianness,
		struct microCDR *m_cdrBuffer);
...
* @return 0 is returned when the serialezed works successfully. Otherwise, -1 is returned.
*/
microcdr_DllAPI int8_t deserializeIntArrayEndianness(int32_t **int_t, const uint32_t numElements, Endianness endianness,
		struct microCDR *m_cdrBuffer);
...
* @return 0 is returned when the serialezed works successfully. Otherwise, -1 is returned.
*/
microcdr_DllAPI int8_t serializeUnsignedCharSequenceEndianness(const unsigned char *uchar_t, const uint32_t numElements,
		Endianness endianness, struct microCDR *m_cdrBuffer);
...
* @return 0 is returned when the deserialezed works successfully. Otherwise, -1 is returned.
*/
microcdr_DllAPI int8_t deserializeLongSequenceEndianness(int64_t **long_t, uint32_t *numElements, Endianness endianness,
		struct microCDR *m_cdrBuffer);
...
* @return 0 is returned when the deserialezed works successfully. Otherwise, -1 is returned.
*/
microcdr_DllAPI int8_t deserializeUnsignedLongLongSequence(unsigned long long int **ulonglong_t, uint32_t *numElements,
		struct microCDR *m_cdrBuffer);
...
* @return 0 is returned when the deserialezed works successfully. Otherwise, -1 is returned.
*/
microcdr_DllAPI int8_t deserializeFloatSequenceEndianness(float **float_t, uint32_t *numElements, Endianness endianness,
		struct microCDR *m_cdrBuffer);
