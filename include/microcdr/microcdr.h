...
microcdr_DllAPI uint32_t micro_buffer_size(const MicroBuffer* buffer);
microcdr_DllAPI uint32_t micro_buffer_length(const MicroBuffer* buffer);
microcdr_DllAPI uint32_t micro_buffer_remaining(const MicroBuffer* buffer);
