...
/*
 ...
 - EPROSIMA_LIB_NAME
 - NANOCDR_VERSION_MAJOR
 - NANOCDR_VERSION_MINOR
*/
    ...
    && defined(NANOCDR_VERSION_MAJOR) \
    && defined(NANOCDR_VERSION_MINOR)
        #pragma comment(lib, EPROSIMA_LIB_PREFIX EPROSIMA_STRINGIZE(EPROSIMA_LIB_NAME) EPROSIMA_LIB_DEBUG_TAG "-" EPROSIMA_STRINGIZE(NANOCDR_VERSION_MAJOR) "." EPROSIMA_STRINGIZE(NANOCDR_VERSION_MINOR) ".lib")
    #else
