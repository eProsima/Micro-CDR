#ifndef _MICROCDR_MICROCDR_1_H_
#define _MICROCDR_MICROCDR_1_H_
 ...
 */
microcdr_DllAPI void initDeserializedNonAlignedBuffer(char *buffer, uint32_t bufferSize, //R NA
        struct microBuffer *m_microBuffer);
 ...
 * @param m_microBuffer Pointer to already allocated microBuffer.
 */
microcdr_DllAPI void initDeserializedAlignedBuffer(char *buffer, uint32_t bufferSize, //R A
        struct microBuffer *m_microBuffer);
 ...
 * @param m_microBuffer Final microBuffer.
 */
microcdr_DllAPI void newDynamicAlignedBuffer(struct microBuffer ** m_cdrBuffer); //W~ A
 ...
 * @param m_microBuffer Pointer to already allocated microBuffer.
 */
microcdr_DllAPI void initStaticAlignedBuffer(char *buffer, uint32_t bufferSize, struct microBuffer *m_microBuffer); //W A

/*!
 * @brief This function creates a dynamic aligned stream of bytes.
 * @param m_microBuffer Final microBuffer.
 */
microcdr_DllAPI void newDynamicNonAlignedBuffer(struct microBuffer ** m_cdrBuffer); //W~ NA
 ...
 * @param m_microBuffer Pointer to already allocated microBuffer.
 */
microcdr_DllAPI void initStaticNonAlignedBuffer(char * buffer, uint32_t bufferSize, struct microBuffer *m_microBuffer); //W NA
